    ...
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="text-center max-w-md mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link to="/" className="flex items-center gap-2 px-8 py-3.5 rounded-2xl bg-gradient-to-r from-[#A7FF00] to-[#5CFF00] text-[#050A12] font-bold font-heading shadow-lg shadow-[rgba(124,255,0,0.3)] hover:shadow-[rgba(124,255,0,0.5)] hover:-translate-y-0.5 transition-all duration-300">
            <Home className="h-5 w-5" /> {t("404.home")}
          </Link>
          <Link to="/auctions" className="flex items-center gap-2 px-8 py-3.5 rounded-2xl border border-[rgba(0,200,255,0.3)] text-[#00C8FF] font-bold font-heading hover:bg-[rgba(0,200,255,0.1)] hover:border-[rgba(0,200,255,0.5)] transition-all duration-300">
