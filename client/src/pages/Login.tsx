      ...
      <div className="relative mx-auto max-w-sm px-4 py-20 w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end -mt-2">
            <Link to="/forgot-password" className="text-xs text-gray-500 hover:text-[#00C8FF] transition-colors">
              {t("auth.forgotPasswordLink")}
            </Link>
          </div>
          <button type="submit" disabled={submitting} className="btn-primary w-full text-base py-3 font-heading">
