  ...
  return (
    <LegalLayout title="Ceník a poplatky" lastUpdated="14. 5. 2026">
      ...
      <section>
        ...
        <div className="rounded-xl bg-[#0B1220] border border-[rgba(0,200,255,0.1)] overflow-hidden">
        ...
        <p className="text-xs text-gray-500 mt-2">Provize se počítá z konečné prodejní ceny. Founder účty: 3 %, VIP účty: 3 %.</p>
      </section>

      <section>
        <h2 className="text-lg font-bold font-heading text-white mb-3">VIP předplatné</h2>
        <div className="rounded-xl bg-[#0B1220] border border-[rgba(0,200,255,0.1)] p-4">
